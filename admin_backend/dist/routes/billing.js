...
billingRouter.get('/billing/overview', asyncHandler(async (request, response) => {
...
billingRouter.get('/billing/invoices', asyncHandler(async (request, response) => {
    await requireAdminPermission(request, response, 'invoice.view', [
        'ops_admin',
        'billing_admin',
        'case_manager',
...
billingRouter.post('/billing/invoices', asyncHandler(async (request, response) => {
    ...
    response.status(201).json(await adminBillingService.createPackageInvoice(actor.userId, actor.roleCodes[0] || actor.actorTypeCode, request.body));
}));
billingRouter.get('/billing/invoices/:invoiceId', asyncHandler(async (request, response) => {
    await requireAdminPermission(request, response, 'invoice.view', [
        'ops_admin',
        'billing_admin',
        'case_manager',
...
billingRouter.get('/billing/invoices/:invoiceId/pdf', asyncHandler(async (request, response) => {
    await requireAdminPermission(request, response, 'invoice.view', [
        'ops_admin',
        'billing_admin',
        'case_manager',
...
billingRouter.post('/billing/invoices/:invoiceId/send-email', asyncHandler(async (request, response) => {
    await requireCsrf(request);
    ...
    response.status(200).json(await adminBillingService.sendInvoiceEmail(getRouteParam(request.params.invoiceId), payload));
}));
billingRouter.get('/billing/payments', asyncHandler(async (request, response) => {
...
billingRouter.post('/billing/payments', asyncHandler(async (request, response) => {
    await requireCsrf(request);
    const actor = await requireAdminPermission(request, response, 'payment.manage', [
        'ops_admin',
        'billing_admin',
    ]);
    response.status(201).json(await adminBillingService.recordManualPayment(actor.userId, actor.roleCodes[0] || actor.actorTypeCode, request.body));
}));
billingRouter.get('/billing/refunds', asyncHandler(async (request, response) => {
...
billingRouter.post('/billing/refunds', asyncHandler(async (request, response) => {
    await requireCsrf(request);
    ...
    response
        .status(201)
        .json(await adminBillingService.createRefund(actor.publicId, actor.roleCodes[0] || actor.actorTypeCode, payload));
}));
