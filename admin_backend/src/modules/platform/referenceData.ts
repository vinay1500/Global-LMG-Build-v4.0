export const ROLE_SEEDS = [
  ...
  {
    code: 'messaging_desk',
    description: 'Client communications and reply desk',
    name: 'Messaging Desk',
  },
  {
    code: 'management_viewer',
    description: 'Read-only operational and management visibility',
...
export const PERMISSION_SEEDS = [
  ...
  ['message.view', 'message', 'view', 'View thread messages'],
  ...
  ['task.view', 'task', 'view', 'View admin tasks'],
  ['task.manage', 'task', 'manage', 'Manage admin tasks'],
  ['audit.view', 'audit', 'view', 'View audit activity'],
  ['report.view', 'report', 'view', 'View reports and operational summaries'],
