...
if (parsedEnv.GOOGLE_CALENDAR_PROVIDER_MODE === 'google-calendar') {
  if (
    !parsedEnv.GOOGLE_CALENDAR_SERVICE_ACCOUNT_EMAIL ||
    !parsedEnv.GOOGLE_CALENDAR_SERVICE_ACCOUNT_PRIVATE_KEY ||
    !parsedEnv.GOOGLE_CALENDAR_ID
  ) {
    throw new Error(
      'GOOGLE_CALENDAR_PROVIDER_MODE=google-calendar requires GOOGLE_CALENDAR_ID, GOOGLE_CALENDAR_SERVICE_ACCOUNT_EMAIL, and GOOGLE_CALENDAR_SERVICE_ACCOUNT_PRIVATE_KEY.'
    );
  }
}
