...
if (parsedEnv.SMS_PROVIDER_MODE === 'twilio-verify') {
    if (!parsedEnv.TWILIO_ACCOUNT_SID ||
        ...
        throw new Error('SMS_PROVIDER_MODE=twilio-verify requires TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, and TWILIO_VERIFY_SERVICE_SID.');
    }
}
...
if (parsedEnv.APP_ENV === 'production') {
    ...
    if (parsedEnv.EMAIL_PROVIDER_MODE === 'preview' ||
