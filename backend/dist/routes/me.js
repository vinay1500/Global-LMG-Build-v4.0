...
const requireClientActor = async (request, response) => {
...
const getUserAgent = (request) => request.get('user-agent') || null;
meRouter.get('/me/preferences', asyncHandler(async (request, response) => {
    const authenticatedUser = await requireAuthenticatedUser(request, response);
    const preferences = await clientAccountsService.getNotificationPreferences(authenticatedUser.id);
    response.json(preferences);
}));
meRouter.put('/me/preferences', asyncHandler(async (request, response) => {
    requireCsrf(request);
    const authenticatedUser = await requireAuthenticatedUser(request, response);
    const preferences = notificationPreferencesSchema.parse(request.body);
    const nextPreferences = await clientAccountsService.updateNotificationPreferences(authenticatedUser.id, preferences);
    response.json(nextPreferences);
}));
meRouter.get('/me/client-account', asyncHandler(async (request, response) => {
...
meRouter.get('/me/matters', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
...
meRouter.get('/me/matters/:matterId', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
    assertPermission(actor.permissionCodes, 'matter.view');
...
meRouter.get('/me/documents', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
...
meRouter.get('/me/documents/:documentId', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
    assertPermission(actor.permissionCodes, 'document.view');
    const document = await domainService.getClientDocument(actor.clientAccountId, getRouteParam(request.params.documentId));
    response.json(document);
}));
meRouter.get('/me/documents/:documentId/download', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
    assertPermission(actor.permissionCodes, 'document.download');
    const result = await documentStorageService.getClientDocumentDownload(actor.publicId, actor.clientAccountId, getRouteParam(request.params.documentId), {
...
meRouter.get('/me/events', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
...
meRouter.get('/me/invoices', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
...
meRouter.get('/me/invoices/:invoiceId', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
    assertPermission(actor.permissionCodes, 'invoice.view');
    const invoice = await domainService.getClientInvoice(actor.clientAccountId, getRouteParam(request.params.invoiceId));
    response.json(invoice);
}));
meRouter.get('/me/invoices/:invoiceId/download', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
    assertPermission(actor.permissionCodes, 'invoice.view');
    const invoice = await domainService.getClientInvoice(actor.clientAccountId, getRouteParam(request.params.invoiceId));
...
meRouter.get('/me/payments', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
...
meRouter.get('/me/refunds', asyncHandler(async (request, response) => {
    const actor = await requireClientActor(request, response);
