...
const getCookies = (cookieHeader) => parseCookies(cookieHeader);
const getUserAgent = (request) => request.header('user-agent')?.trim() || null;
const setCsrfCookie = (response) => {
...
const setSessionCookie = (response, rawToken, rememberMe) => {
...
const setFlowCookie = (response, rawToken) => {
...
authRouter.post('/auth/sign-in', asyncHandler(async (request, response) => {
...
authRouter.post('/auth/sign-up', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
...
authRouter.post('/auth/google', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
...
authRouter.post('/auth/verify-email', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
...
authRouter.post('/auth/google/phone', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
    const payload = phoneCaptureSchema.parse(request.body);
    const cookies = getCookies(request.headers.cookie);
    const result = await authService.submitGooglePhone(cookies[env.AUTH_FLOW_COOKIE_NAME], payload.phone, payload.country);
    applyAuthResultCookies(response, result);
    response.json(result.result);
}));
authRouter.post('/auth/verify-phone-otp', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
    const payload = verificationSchema.parse(request.body);
    const cookies = getCookies(request.headers.cookie);
    const result = await authService.verifyPhoneOtp(cookies[env.AUTH_FLOW_COOKIE_NAME], payload.code);
    applyAuthResultCookies(response, result);
    response.json(result.result);
}));
authRouter.post('/auth/password-reset/request', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
...
authRouter.post('/auth/password-reset/confirm', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
...
authRouter.post('/auth/email-verification/resend', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
    const cookies = getCookies(request.headers.cookie);
    const result = await authService.resendEmailVerification(cookies[env.AUTH_FLOW_COOKIE_NAME]);
    applyAuthResultCookies(response, result);
    response.json(result.result);
}));
authRouter.post('/auth/phone-otp/resend', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
    const cookies = getCookies(request.headers.cookie);
...
authRouter.post('/auth/password-reset/resend', asyncHandler(async (request, response) => {
    requireCsrf(request, response);
    const cookies = getCookies(request.headers.cookie);
    const result = await authService.resendPasswordReset(cookies[env.AUTH_FLOW_COOKIE_NAME]);
    applyAuthResultCookies(response, result);
    response.json(result.result);
}));
