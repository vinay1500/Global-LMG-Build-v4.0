...
// Edit public Careers page and careers listing copy here.
...
export const CAREERS_PAGE_CONTENT = {
  ...
  ctaButtonLabel: 'Submit Your Resume',
  ...
  heroImage: selfHostedUnsplashImage('photo-1521737711867-e3b97375f902'),
  heroIntro:
  ...
  opportunitiesTitle: 'Explore Opportunities',
  openingsTitle: 'Current Openings',
  sectionTitle: `Why ${BRAND_NAME}?`,
} as const;

export const CAREERS_HOME_SECTION = {
  ctaBody:
  ...
  ctaButtonLabel: 'Contact Recruitment',
  ctaTitle: 'Ready to redefine the future of law?',
  intro: CAREERS_PAGE_CONTENT.heroIntro,
